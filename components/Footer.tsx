...
<footer
  className="bg-white  text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
  <div
  ...
  <div className="bg-black text-white p-6 text-center">
    ...
    <a className="font-semibold" href="https://mhantich.vercel.app/"
      >Mhantich</a
    >
  </div>
</footer>
