...
import { Box, ClipboardCopy, File, Signature, TableColumnsSplit } from "lucide-react";
...
const SkeletonOne = () => {
  ...
  return (
    <motion.div
      initial="initial"
      whileHover="animate"
      className="flex flex-1 w-full h-full min-h-[6rem] bg dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-col space-y-2"
    >
      <motion.div
        variants={variants}
